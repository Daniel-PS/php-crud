        ...
        <div class="sub-creation-center">
            <form class="form" method="POST" action="" enctype="multipart/form-data">
                ...
                <div class="form-inputs">
                    ...
                    <input class="input-field" class="input-field" value="<?= old('name') ?>" type="text" name="name" placeholder="Type Saint's name">
                    ...
                    <input class="input-field" type="text" name="country" value="<?= old('country') ?>"  placeholder="Type Nation">
                    ...
                    <input data-mask="00/00/0000" class="input-field" type="text" name="birthday" value="<?= old('birthday') ?>"  placeholder="Birthday">
                    ...
                    <textarea class="input-field" name="info" rows="10" maxlength="500" cols="30" value="<?= old('info') ?>"  placeholder="Information about the Saint"></textarea>
